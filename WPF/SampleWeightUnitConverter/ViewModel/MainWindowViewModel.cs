...
namespace SampleWeightUnitConverter {
    public class MainWindowViewModel : ViewModel{
        ...
        //下のComboBoxで選択されている値
        public ProundUnit CurrentImperialUnit { get; set; }
        ...
        public MainWindowViewModel()
        {
            ...
            CurrentImperialUnit = ProundUnit.Units.First();

            MetricToImperialUnit = new DelegateCommand(() => 
                            ImperialValue = CurrentImperialUnit.
                            FromMetricUnit(CurrentMetricUnit, MetricValue));

            ImperialUnitToMetric = new DelegateCommand(() =>
                            MetricValue = CurrentMetricUnit.
                            FromImperialUnit(CurrentImperialUnit, ImperialValue));
        }
